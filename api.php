...
function get_student_list(){
    ...
    $student_list = array(array("id" => 1, "name" => "Adrian Corder"),
                          array("id" => 2, "name" => "Victor Ferry"),
                          array("id" => 3, "name" => "Coadar Green"),
                          array("id" => 4, "name" => "Border Noance"),
                          array("id" => 5, "name" => "Victor Fercy"));
